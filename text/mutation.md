...
Потратив количество очков, равное 2 × ПО выбранного Зверя для «Дикого облика», вы заставляете своё тело синтезировать взрывчатое вещество, вы выбираете тип урона: Огонь, Кислота или Колющий. Когда ваши хиты опускаются до 0 или вы используете действие что бы применить способность досрочно, вы взрываетесь и выходите из Дикого Облика, заставляя всех существ в радиусе 20 футов от вас совершить спасбросок Ловкости против ваших заклинаний Друида. Существа провалившие спасбросок получают урон соответствующего типа в размере бросков к10, количество которых равно: 1 + 2 × ПО выбранного зверя. При успехе существа получают половину урона от взрыва. Вы так же получаете урон от своего взрыва и автоматически проваливаете спасбросок.
